...
In virtue of the motto "TYPO3 inspires people to share!", the site package extension can also be shared with the community via the official `TYPO3 Extension Repository <https://extensions.typo3.org>`_ and/or in a publicly accessible version control system such as `GitHub <https://github.com>`_.

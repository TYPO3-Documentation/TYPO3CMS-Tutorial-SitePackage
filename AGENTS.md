...
Documentation/CodeSnippets/      # auto-generated example site package files, regenerated by `make codesnippets`
Build/DownloadSitePackage/       # script that generates the CodeSnippets content
...
6. **Do not hand-edit `Documentation/CodeSnippets/`** — that tree is generated
   by `make codesnippets` from `Build/DownloadSitePackage/`. Change the
   source there and regenerate instead.

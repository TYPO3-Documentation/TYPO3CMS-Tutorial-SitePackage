...
In :path:`packages/my_site_package/Resources/Private/Templates/Partials/Navigation/Menu.fluid.html`
...
..  literalinclude:: /CodeSnippets/my_site_package/Resources/Private/Templates/Partials/Navigation/Menu.fluid.html
    :caption: packages/my_site_package/Resources/Private/Templates/Partials/Navigation/Menu.fluid.html
    :linenos:
...
..  code-block:: diff
    :caption: packages/my_site_package/Resources/Private/Templates/Partials/Navigation/Menu.fluid.html (changed for debug output)
...
*   A breadcrumb configured in
    ...
    and rendered in :file:`packages/my_site_package/Resources/Private/Templates/Partials/Navigation/Breadcrumb.fluid.html`.
*   A footer menu consisting of pages within a selected folder configured in
    ...
    and rendered in :file:`packages/my_site_package/Resources/Private/Templates/Partials/Navigation/FooterMenu.fluid.html`.
